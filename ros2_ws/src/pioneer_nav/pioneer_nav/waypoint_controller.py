...
class WaypointController(Node):
    def __init__(self):
        ...
        self.declare_parameter("coverage_scan_spin_s", 8.0)
        self.declare_parameter("coverage_scan_turn_speed", 0.8)
        ...
        self.declare_parameter("front_obstacle_dist_m", 0.45)
        self.declare_parameter("critical_obstacle_dist_m", 0.22)
