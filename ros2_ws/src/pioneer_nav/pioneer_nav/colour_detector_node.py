...
class ColourDetectorNode(Node):
    ...
    def image_callback(self, msg):
        ...
        # Match the letter detector's conversion exactly, then fix channel order.
        # The OAK-D publishes RGB8 by default, not BGR8 — check encoding to be safe.
