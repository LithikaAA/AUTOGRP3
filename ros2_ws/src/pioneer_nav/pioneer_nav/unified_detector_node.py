...
class UnifiedDetectorNode(Node):
    ...
    def __init__(self):
        ...
        self.mask_green_ground = bool(self.get_parameter("mask_green_ground").value)
        self.min_paper_bright  = int(self.get_parameter("min_paper_brightness").value)
        self.min_dark_ratio    = float(self.get_parameter("min_dark_ratio").value)
        self.max_dark_ratio    = float(self.get_parameter("max_dark_ratio").value)
